...
<div class="container">
    ...
    <div class="row">
        <h2 align="center">Listado de tus servicios</h2>
        <a href="crearservicio" class="btn btn-secondary">Crear un nuevo servicio</a>
        <br />
        <br />
        <table id="tabla1" class="table table-striped table-bordered" style="width:100%">
            ...
            <tr>
                ...
                <td align="center">
                    <a href="{!!'vermiservicio/'.$servicio->id!!}" class="btn btn-dark">
                    ...
                    <a href="{!!'editarservicio/'.$servicio->id!!}" class="btn btn-secondary">
                        ...
                        <a href="{!!'eliminarservicio/'.$servicio->id!!}" class="btn btn-danger">
